...
The final output is a path with named assumptions and sources. It can be updated when the event changes, and challenged at the exact step where the evidence is weak.
