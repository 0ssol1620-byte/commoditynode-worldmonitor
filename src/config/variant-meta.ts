...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  commoditynode: {
    ...
    classification: 'Commodity Intelligence Dashboard, Supply Chain Research',
    categories: ['finance', 'business'],
    features: [
      'Commodity impact map',
      'Material commodity event pulse',
      'Benchmark and proxy tape',
      'Supply chain and shipping context',
      'Route and chokepoint monitoring',
      'Evidence-backed market implications',
